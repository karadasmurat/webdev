...
function fpstyle() {
    ...
    initialValue = 0;
    const totalCost = groceries.reduce((accumulator, currentValue) => accumulator + (currentValue.price * currentValue.quantity), initialValue);
    ...
    const cheapest = groceries.reduce((min, currentValue) => (currentValue.price < min) ? currentValue.price : min, Infinity);
